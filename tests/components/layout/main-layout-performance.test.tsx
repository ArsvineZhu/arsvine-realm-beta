...
vi.mock('../../../hooks/useDrawerNavigation', () => ({
  default: () => ({
    drawerOpen: false,
    navLinks: [],
...
vi.mock('../../../hooks/useLayoutRouteMode', () => ({
  default: () => ({
    isHome: false,
    isContentPage: true,
    isStandalone: false,
...
vi.mock('../../../hooks/useStandalonePanelState', () => ({
  default: () => ({
...
vi.mock('../../../hooks/useRouteLoadingKind', () => ({
  default: () => ({
    kind: null,
...
vi.mock('../../../hooks/useMobileTesseractCharge', () => ({
  default: (options: unknown) => recordMobileTesseractChargeCall(options),
}));

vi.mock('../../../components/shared/HomeLoadingScreen', () => ({
  default: () => <div data-testid="home-loading-screen" />,
}));

vi.mock('../../../components/interactive/MusicPlayer', () => ({
  default: () => <div data-testid="music-player" />,
}));

vi.mock('../../../components/layout/GlobalHud', () => ({
...
vi.mock('../../../components/layout/RouteLoadingOverlay', () => ({
