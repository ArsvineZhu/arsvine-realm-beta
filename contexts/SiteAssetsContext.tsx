...
import { buildManagedAssetUrl, normalizeCdnBase } from '../lib/cdn';
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const manifestResponse = await fetch(`${base}/realm/site-catalog/versions/${pointer.version}/assets.json`, { signal: controller.signal });
